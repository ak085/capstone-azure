...
export default function Product_single_card_delete(props) {
                ...
                <div className="card-body">
                    <div className="form-check">
                        <input
                            ...
                            onChange={(e) => {
                                const newItem = e.target.checked ? props.item.productid.toString() : "";
                                console.log(`Product_single_card_delete: checkbox index ${props.listIndex} new item value: ${newItem}`);
                                props.onUpdate(props.listIndex, newItem);
                            }}
                        ></input>
